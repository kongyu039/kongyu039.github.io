...
const dbJson = {
  ...
  proj_list: [
    ...
    },
    {
      ...
      desc: "（不知具体怎么描述，暂时复制点内容填充，后续开发到会明确）这里项目开发的过程资料和资源或文档以及个人的想法，帮助您更好地了解的项目。",
      emoji: "📚", bgUrl: "proj-bg4.jpg",
    },
    {
      title: "电脑问题", summary: "（等待）在线接单解决电脑问题",
      desc: "（不知具体怎么描述，暂时复制点内容填充，后续开发到会明确）就是解决一些电脑的问题(前置条件是必须能正常开机和能远程，至少得是非硬件问题)，比如广告弹窗，软件，分盘，清理垃圾，重装系统啥的",
      emoji: "🌷", bgUrl: "proj-bg5.jpg",
    },
    {
      title: "代做项目", summary: "（等待）在线软件接单项目或软件简单问题",
      desc: "（不知具体怎么描述，暂时复制点内容填充，后续开发到会明确）接点中小型的项目或定制项目，解决点简单问题或者初学者问题（适合新手小白/入门/编程语言的起点）",
